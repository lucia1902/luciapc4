...
st.markdown("<h1 style='text-align: center;'>Conociendo a mis gatos</h1>", unsafe_allow_html=True)
...
col1.image("perfil.jpg", caption='Aca estoy con mi gata llamada Milo', width=300)
...
texto = """
Me gusta pintar, escuchar musica y mi serie favorita es Bridgerton.
"""
...
st.markdown("<h2 style='text-align: center;'>Aprender a programar en Python ha sido una experiencia gratificante y enriquecedora. No solo he adquirido habilidades técnicas, sino también habilidades de resolución de problemas y pensamiento lógico que son útiles en muchos aspectos de la vida. ", unsafe_allow_html=True)
...
texto_2 = """
Al inicio me parecio dificil usar Phyton y me senti un poco perdida con respecto a los codigos , en especial cuando llegamos a la parte de if,else . Pero se me hizo mas sencillo de entender al momento de ver tablas y mapas, ya que me parecio mas interesante y didactico crear tablas a partir de las bases de datos que se nos proporcionaba en el horario de practica 
"""
...
sidebar.markdown("<h1 style='text-align: center;'>Primer grafico que realice en mi ultima PC</h1>", unsafe_allow_html=True)
...
graficos = ['Gráfico de tarjetas amarillas', 'Gráfico de tarjetas rojas', 'Mapas de lenguas por familia']
...
if grafico_seleccionado == 'Gráfico de tarjetas amarillas':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>Representa las tarjetas amarillas a el equipo local</div>", unsafe_allow_html=True)
    ...
    sidebar.markdown("<div style='text-align: justify'> Representa las tarjetas rojas para el equipo visitante.</div>", unsafe_allow_html=True)
    sidebar.image("barras_tarjeta_rojas.png", caption='Gráfico de tarjetas rojas', width=500)
    pass
elif grafico_seleccionado == 'Mapas de lenguas por familia':
    sidebar.markdown("<div style='text-align: justify'>Lenguas por familia.</div>", unsafe_allow_html=True)
    sidebar.image("lenguas_por_familia.png", caption='Mapa de lenguas por familia', width=500)
    pass
